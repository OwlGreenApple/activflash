...
}(jQuery), $("body").append('<div id="tag_modal" class="modal fade" tabindex="-1" role="dialog">    <div class="modal-dialog">        <div class="modal-content">            <div class="modal-header">                <h3 class="lcl_options"></h3>            </div>            <div class="modal-body">                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="owner" checked> <span class="lcl_collect_media_owners"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="likes" checked> <span class="lcl_collect_who_likes_media"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="comments" checked> <span class="lcl_collect_comments_on_media"></span>                </div>            </div>            <div class="modal-footer">                <div class="fcol-lg-10 col-lg-offset-2" style="display: -webkit-inline-box">                    <button class="btn btn-default lcl_cancel" data-dismiss="modal"></button>                    <button id="save_tag" class="btn btn-primary lcl_save" style="margin-bottom:5px;border-radius : 5px;"></button>                </div>            </div>        </div>    </div></div>'), $("body").append('<div id="location_modal" class="modal fade" tabindex="-1" role="dialog">    <div class="modal-dialog">        <div class="modal-content">            <div class="modal-header">                <h3 class="lcl_options"></h3>            </div>            <div class="modal-body">                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="owner_l" checked> <span class="lcl_collect_media_owners"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="likes_l" checked> <span class="lcl_collect_who_likes_media"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="comments_l" checked> <span class="lcl_collect_comments_on_media"></span>                </div>            </div>            <div class="modal-footer">                <div class="fcol-lg-10 col-lg-offset-2" style="display: -webkit-inline-box">                    <button class="btn btn-default lcl_cancel" data-dismiss="modal" style="margin-bottom:5px;border-radius : 5px;"></button>                    <button id="save_location" class="btn btn-primary lcl_save" style="margin-bottom:5px;border-radius : 5px;"></button>                </div>            </div>        </div>    </div></div>'), $("body").append('<div id="commenters_modal" class="modal fade" tabindex="-1" role="dialog">    <div class="modal-dialog">        <div class="modal-content">            <div class="modal-header">              <h3 class="lcl_options"></h3>            </div>            <div class="modal-body">                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="likes_c" checked> <span class="lcl_collect_who_likes_media"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="checkbox" id="comments_c" checked> <span class="lcl_collect_comments_on_media"></span>                </div>            </div>            <div class="modal-footer">              <div class="fcol-lg-10 col-lg-offset-2" style="display: -webkit-inline-box">                <button class="btn btn-default lcl_cancel" data-dismiss="modal" style="margin-bottom:5px;border-radius : 5px;"></button>                <button id="save_commenters" class="btn btn-primary lcl_save" style="margin-bottom:5px;border-radius : 5px;"></button>              <div>            </div>        </div>    </div></div>'), $("body").append('<div id="followers_modal" class="modal fade" tabindex="-1" role="dialog">    <div class="modal-dialog">        <div class="modal-content">            <div class="modal-header">                <h3 class="lcl_options"></h3>            </div>            <div class="modal-body">                <div style="display: -webkit-inline-box">                    <input type="radio" name="followers_type" id="followers_all" checked> <span class="lcl_collect_followers_all" style="vertical-align: -webkit-baseline-middle"></span><br>                </div>                <div style="display: -webkit-inline-box">                    <input type="radio" name="followers_type" id="followers_new"> <span class="lcl_collect_followers_new" style="vertical-align: -webkit-baseline-middle"></span>                </div>            </div>            <div class="modal-footer">                <div class="fcol-lg-10 col-lg-offset-2" style="display: -webkit-inline-box">                    <button class="btn btn-default lcl_cancel" data-dismiss="modal" style="margin-bottom:5px;border-radius : 5px;"></button>                    <button id="save_followers_type" class="btn btn-primary lcl_save" style="margin-bottom:5px;border-radius : 5px;"></button>                </div>            </div>        </div>    </div></div>'), $("body").append('<div id="user_buttons" style="display:none; position: fixed;bottom: 20px;right: 20px;"><button class="btn btn-success" data-user="" id="commenters_btn" style="margin-bottom:5px;border-radius : 5px;"></button> <button class="btn btn-success" data-user="" id="followers_btn" style="margin-bottom:5px;border-radius : 5px;"></button> </div>'), $("body").append('<button style="margin-bottom:5px;border-radius : 5px;display:none; position: fixed;bottom: 20px;right: 20px;" class="btn btn-success" data-tag="" id="tag_button"></button>'), $("body").append('<button style="display:none; position: fixed;bottom: 60px;right: 20px;margin-bottom:5px;border-radius : 5px;" class="btn btn-primary" data-tag="" id="likes_button"></button>'), $("body").append('<button data-action="add" style="display:none; position: fixed;bottom: 20px;right: 20px;margin-bottom:5px;border-radius : 5px;" data-location="" class="btn btn-success" id="location_button"></button>'), $(".lcl_options").text(chrome.i18n.getMessage("lcl_options")), $(".lcl_collect_media_owners").text(chrome.i18n.getMessage("lcl_collect_media_owners")), $(".lcl_collect_who_likes_media").text(chrome.i18n.getMessage("lcl_collect_who_likes_media")), $(".lcl_collect_comments_on_media").text(chrome.i18n.getMessage("lcl_collect_comments_on_media")), $(".lcl_cancel").text(chrome.i18n.getMessage("lcl_cancel")), $(".lcl_save").text(chrome.i18n.getMessage("lcl_save")), $(".lcl_collect_followers_new").text(chrome.i18n.getMessage("lcl_collect_followers_new")), $(".lcl_collect_followers_all").text(chrome.i18n.getMessage("lcl_collect_followers_all")), $("#likes_button").click(function() {
    message = {
